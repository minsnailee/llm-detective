...
export default function GamePlayPage() {
      ...
      try {
        ...
        if (res.data.contentJson) {
          try {
            ...
            setCharacters([
              { name: "AI 용의자 1", role: "용의자", personality: "", alibi: "" },
              { name: "AI 용의자 2", role: "용의자", personality: "", alibi: "" },
              { name: "AI 용의자 3", role: "용의자", personality: "", alibi: "" },
            ]);
          }
        } else {
  ...
  return (
    <div style={{ padding: "20px" }}>
      {/* 개요 다시보기 */}
      <button onClick={() => setShowSummary((prev) => !prev)}>개요 다시보기</button>
