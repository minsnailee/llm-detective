 ...
 * - caseTitle/caseSummary/facts/finalAnswer/goldAnswer/engine를 전달해 정확도 향상
 */
@Data
public class NlpAnalyzeRequest {
    ...
    // [ADD] 정답 설정(범인/동기/수법/핵심증거) 메타 전달
    // 예: { culpritId, culpritName, motive, method, keyEvidenceIds: List<String> }
    private Map<String, Object> goldAnswer;

    // 엔진 고정(“hf” or “dummy”), 미설정 시 서버 기본값 사용
